...
const htmlBlock = {
    priority: "A",
    type: "html",
    match: matcherf(variables.allHtmlTags),
    passMatchedArgs: true,
    run(tag, text) {
        const parsed = {
            tag,
