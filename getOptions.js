...
function getOptions(flavor) {
    ...
    const visitor = visitorRef[flavor] || {}

    assignFresh(visitor, {stringify: xmlString})
    return {
        blocks, options, state, visitor
    }
}
