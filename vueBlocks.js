...
const rootVisitBlock = {
        ...
        visit(node) {
            const children = this.visitChildren(node)
            return this.state.build(node, children)
        }
}
// no list blocks
const vueBlocks = [
